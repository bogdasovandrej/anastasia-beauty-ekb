# 🚀 Пошаговая инструкция: Настройка anastasia-beauty-ekb.ru

## Шаг 1: Покупка домена anastasia-beauty-ekb.ru

1. Зайдите на [reg.ru](https://reg.ru)
2. В поиске введите: `anastasia-beauty-ekb.ru`
...
git remote add origin https://github.com/ВАШ_НИКNAME/anastasia-beauty-ekb.git
...
## Шаг 3: Подключение домена anastasia-beauty-ekb.ru к Vercel
...
5. Введите: `anastasia-beauty-ekb.ru`
6. Нажмите **"Add"**
...
3. Найдите `anastasia-beauty-ekb.ru`
...
3. Введите: `www.anastasia-beauty-ekb.ru`
4. Нажмите **"Add"**
...
1. В Vercel: **"Settings"** → **"Domains"**
2. Нажмите на `anastasia-beauty-ekb.ru`
...
3. **Домен:**
   - Откройте `https://anastasia-beauty-ekb.ru`
...
| Услуга | Цена |
|--------|------|
| Домен anastasia-beauty-ekb.ru (1 год) | ~169₽ |
...
- [ ] Домен anastasia-beauty-ekb.ru куплен на reg.ru
- [ ] Сайт загружен на Vercel
- [ ] DNS-серверы настроены на Vercel
- [ ] Домен подключён к Vercel
- [ ] HTTPS включён
- [ ] Сайт открывается по https://anastasia-beauty-ekb.ru
